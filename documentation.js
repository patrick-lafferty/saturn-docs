...
return: {link: '', type: 'void'},
 description: ''}, {name: 'combineFlags',
 signature: [{link: '', type: 'Arg...'}],
return: {link: '', type: 'uint32_t'},
 description: ''}, {name: 'sendInitIPI',
 signature: [{link: '', type: 'int'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'sendStartupIPI',
...
{type: 'file',
 classType: 'fileType',
 name: 'cpu.h',
 contents: {classes: [{name: 'CPUControlBlock',
 classComment: '',
 publicMethods: []}], freeFunctions: [{name: 'setupCPUBlocks',
 signature: [{link: '', type: 'int'}, {link: '/kernel/arch/i386/cpu/cpu.h', type: 'CPU::CPUControlBlock'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'exitCurrentTask',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'exitKernelTask',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'sleepCurrentTask',
...
return: {link: '', type: 'void'},
 description: '//TODO: move this later'}, {name: 'receiveMessage',
...
return: {link: '', type: 'bool'},
 ...
 signature: [{link: '/kernel/task.h', type: 'Kernel::Task *'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'getTask',
 signature: [{link: '', type: 'uint32_t'}],
return: {link: '/kernel/task.h', type: 'Kernel::Task *'},
 description: ''}, {name: 'changePriority',
 signature: [{link: '/kernel/task.h', type: 'Kernel::Task *'}, {link: '', type: 'Kernel::Priority'}],
return: {link: '', type: 'void'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
...
{type: 'file',
 ...
 contents: {classes: [{name: 'BlockAllocator',
 classComment: '    Temp design just to make sure everything else works first, no freeing    ',
 publicMethods: [{name: 'allocate',
 signature: [],
return: {link: '', type: 'T *'},
 description: ''}, {name: 'allocateFrom',
 signature: [{link: '', type: 'uint32_t'}],
return: {link: '', type: 'T *'},
 description: ''}, {name: 'allocateMultiple',
 signature: [{link: '', type: 'int'}],
return: {link: '', type: 'T *'},
...
{type: 'file',
 classType: 'fileType',
 name: 'guard.h',
 contents: {classes: [{name: 'MemoryGuard',
 classComment: '',
 publicMethods: []}], freeFunctions: []}}, 
{type: 'file',
 classType: 'fileType',
...
return: {link: '', type: 'uint32_t'},
 ...
 signature: [{link: '/kernel/arch/i386/memory/virtual_memory_manager.h', type: 'Memory::VirtualMemoryManager *'}, {link: '', type: 'bool'}],
...
return: {link: '', type: 'void'},
 description: ''}, {name: 'getDirectoryPhysicalAddress',
 signature: [],
return: {link: '', type: 'uint32_t'},
...
{type: 'file',
 ...
 classComment: '    A Mailbox stores and provides access to messages. Each task    has one mailbox. Messages are stored in a circular byte buffer.    ',
 publicMethods: [{name: 'send',
 signature: [{link: '/kernel/ipc.h', type: 'IPC::Message *'}],
return: {link: '', type: 'void'},
 description: '        Copies the message into the buffer if there is space available,        overwriting any messages that were previously read        '}, {name: 'receive',
 signature: [{link: '/kernel/ipc.h', type: 'IPC::Message *'}],
return: {link: '', type: 'bool'},
 description: '        Extracts a message from the buffer and copies it to the supplied message        '}, {name: 'hasUnreadMessages',
 signature: [],
return: {link: '', type: 'bool'},
 description: ''}, {name: 'getUnreadMessagesCount',
 signature: [],
return: {link: '', type: 'uint32_t'},
 description: ''}]}, {name: 'Message',
 classComment: '    Base class for all messages. Stores the message\'s header    that indicates the size of the message, who sent it and    who will receive it, as well as how to identify the message    ',
 publicMethods: []}, {name: 'MaximumMessageBuffer',
 classComment: '',
 publicMethods: []}], freeFunctions: [{name: 'extractMessage',
 signature: [{link: '/kernel/ipc.h', type: 'const IPC::MaximumMessageBuffer &'}],
return: {link: '', type: 'T'},
 description: '    Helper func that copies the first n bytes from the buffer    to create a T message    '}]}}, 
{type: 'file',
 classType: 'fileType',
 name: 'multiboot.h',
...
return: {link: '', type: 'void'},
 description: 'Grants a single 8-bit IO port. Permissions are stored in an IO port permission bitmap which is allocated per TSS'}, {name: 'grantIOPort16',
 signature: [{link: '', type: 'uint16_t'}, {link: '', type: 'volatile uint8_t *'}],
return: {link: '', type: 'void'},
 description: 'Grants a single 16-bot IO port, or two consecutive 8-bit ports'}, {name: 'blockIOPort16',
 signature: [{link: '', type: 'uint16_t'}, {link: '', type: 'volatile uint8_t *'}],
return: {link: '', type: 'void'},
 description: 'Blocks access to a single 16-bit IO port'}, {name: 'grantIOPortRange',
 signature: [{link: '', type: 'uint16_t'}, {link: '', type: 'uint16_t'}, {link: '', type: 'volatile uint8_t *'}],
return: {link: '', type: 'void'},
 description: 'Grants every port from portStart to portEnd'}]}}, 
{type: 'file',
 classType: 'fileType',
 name: 'scheduler.h',
...
return: {link: '', type: 'bool'},
 ...
 classComment: '',
 publicMethods: [{name: 'notifyTimesliceExpired',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'scheduleTask',
 signature: [{link: '/kernel/task.h', type: 'Kernel::Task *'}],
...
return: {link: '', type: 'bool'},
 ...
 signature: [{link: '', type: 'uint32_t'}],
return: {link: '', type: 'bool'},
 description: ''}]}, {name: 'RegisterService',
 classComment: '',
...
{type: 'file',
 classType: 'fileType',
 name: 'task.h',
 contents: {classes: [{name: 'IdGenerator',
...
return: {link: '/kernel/task.h', type: 'Kernel::Task *'},
 ...
 signature: [{link: '', type: 'uintptr_t'}],
return: {link: '/kernel/task.h', type: 'Kernel::Task *'},
 description: ''}, {name: 'freeKernelTask',
 signature: [{link: '/kernel/task.h', type: 'Kernel::Task *'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'freeUserTask',
 signature: [{link: '/kernel/task.h', type: 'Kernel::Task *'}],
return: {link: '', type: 'void'},
 description: ''}]}, {name: 'InitialKernelStack',
 classComment: '',
 publicMethods: []}, {name: 'Stack',
 classComment: '',
 publicMethods: []}, {name: 'TaskStack',
 classComment: '',
 publicMethods: []}, {name: 'SSEContext',
 classComment: '',
 publicMethods: []}, {name: 'KernelStackExtras',
 classComment: '',
 publicMethods: []}, {name: 'UserStackExtras',
 classComment: '',
 publicMethods: []}, {name: 'Task',
 classComment: '    A Task is a running application or service, which may be    user-mode or kernel-mode    ',
 publicMethods: []}, {name: 'BufferedMailbox',
 classComment: '',
...
return: {link: '/saturn/gemini/environment.h', type: 'Saturn::Gemini::Object *'},
 ...
 classComment: '',
 publicMethods: []}, {name: 'Float',
 classComment: '',
 publicMethods: []}, {name: 'Boolean',
 classComment: '',
 publicMethods: []}, {name: 'String',
 classComment: '',
...
return: {link: '/saturn/gemini/environment.h', type: 'Saturn::Gemini::Environment'},
 ...
 classComment: '',
 publicMethods: []}], freeFunctions: [{name: 'map',
 signature: [{link: '/saturn/parsing.h', type: 'Saturn::Parse::List *'}, {link: '', type: 'Func'}, {link: '/saturn/gemini/environment.h', type: 'Saturn::Gemini::Environment &'}, {link: '', type: 'bool'}],
return: {link: '/saturn/gemini/environment.h', type: 'Saturn::Gemini::List *'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
 name: 'interpreter.h',
...
{type: 'file',
 ...
 classComment: '    Formats individual log events and sends them to the    Event system    ',
 publicMethods: [{name: 'info',
 signature: [{link: '', type: 'const char *'}],
return: {link: '', type: 'void'},
 description: '        Sends the given entry to the Event system.        Info is used for non-error, non-warning events,        ie just verbose debug information        '}]}], freeFunctions: [{name: 'subscribe',
 signature: [],
return: {link: '', type: 'void'},
...
return: {link: '', type: 'bool'},
 ...
 signature: [{link: '', type: 'int'}, {link: '', type: 'Saturn::Parse::SExpType'}],
return: {link: '', type: 'std::optional<T>'},
...
return: {link: '', type: 'void'},
 description: '		Adds a single element to the container with default configuration		'}, {name: 'addChild',
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::UIElement *'}, {link: '', type: 'const std::vector<MetaData> &'}],
return: {link: '', type: 'void'},
 description: '		Adds a single element to the container with some container-specific		configuration		'}, {name: 'addChild',
 signature: [{link: '/services/apollo/lib/elements/container.h', type: 'Apollo::Elements::Container *'}],
return: {link: '', type: 'void'},
 description: '		Adds a single child container with default configuration		'}, {name: 'addChild',
...
return: {link: '', type: 'void'},
 description: '		Adds a single child container with some container-specific		configuration		'}, {name: 'layoutChildren',
 signature: [],
return: {link: '', type: 'void'},
 description: '		Arranges the children in some fashion by calculating each		child element\'s bounds		'}, {name: 'getChildBounds',
...
return: {link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::Bounds'},
 description: '		Returns the bounds of the given child. Bounds are calculated		in a layoutChildren call and stored in the ContainedElement		'}, {name: 'requestLayoutText',
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::UIElement *'}],
return: {link: '', type: 'void'},
 description: '		Forwards text layout requests up the ui hierarchy until it		reaches the Window, which is capable of performing the request.		'}, {name: 'requestRender',
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::UIElement *'}],
return: {link: '', type: 'void'},
 description: '		Forwards render requests up the ui hierarchy until it		reaches the Window, which is capable of performing the request.		'}]}, {name: 'MetaData',
 classComment: '	MetaData is data that is attached to some UI element that its parent	container uses to change how the element is arranged	For example:	Grids have rows and columns. Instead of hardcoding a rowNumber variable	in the base UIElement, the row number can be supplied from elsewhere.	',
 publicMethods: []}, {name: 'ContainedElement',
 classComment: '	Base class for container children. Allows for derived containers	to store container-specific data with each child, such as rows	and columns for Grid children.	',
 publicMethods: []}], freeFunctions: []}}, 
{type: 'file',
 classType: 'fileType',
 name: 'control.h',
 contents: {classes: [{name: 'Control',
 classComment: '    A Control is a user interactive UI Element. It    can receive mouse and keyboard events.    ',
 publicMethods: [{name: 'handleMouseScroll',
 signature: [{link: '/services/mouse/messages.h', type: 'const Mouse::Scroll &'}],
return: {link: '', type: 'void'},
 description: ''}]}], freeFunctions: []}}, 
{type: 'file',
 classType: 'fileType',
 ...
 publicMethods: [{name: 'setupBindings',
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::Configuration &'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
...
return: {link: '', type: 'void'},
 ...
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'onWindowReady',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'hasReceivedWindowReady',
 signature: [],
return: {link: '', type: 'bool'},
...
{type: 'file',
 ...
 publicMethods: [{name: 'create',
 signature: [{link: '/services/apollo/lib/elements/grid.h', type: 'Apollo::Elements::GridConfiguration'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}],
return: {link: '/services/apollo/lib/elements/grid.h', type: 'Apollo::Elements::Grid *'},
...
return: {link: '', type: 'void'},
 ...
 signature: [{link: '/services/apollo/lib/renderer.h', type: 'Apollo::Renderer *'}, {link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::Bounds'}, {link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::Bounds'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'instantiateItemTemplate',
 signature: [{link: '', type: 'Item'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'onItemAdded',
 signature: [{link: '', type: 'Item'}, {link: '', type: 'Apollo::Elements::Grid::Bindings'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
...
{type: 'file',
 ...
 publicMethods: [{name: 'create',
 signature: [{link: '/services/apollo/lib/elements/label.h', type: 'Apollo::Elements::LabelConfiguration'}, {link: '', type: 'BindFunc'}],
return: {link: '/services/apollo/lib/elements/label.h', type: 'Apollo::Elements::Label *'},
 description: ''}, {name: 'layoutText',
 signature: [{link: '/services/apollo/lib/text.h', type: 'Apollo::Text::Renderer *'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'render',
...
{type: 'file',
 ...
 classComment: '    A ListView is a container that arranges its children linearly    in either a row or a column.     ',
 publicMethods: [{name: 'create',
 signature: [{link: '/services/apollo/lib/elements/listview.h', type: 'Apollo::Elements::ListViewConfiguration'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}],
return: {link: '/services/apollo/lib/elements/listview.h', type: 'Apollo::Elements::ListView *'},
 description: '        A helper function to create ListViews that use databinding.        The *BindFuncs use templates, constructors for non-template classes        can\'t be templated, hence the need for a static function        '}, {name: 'addChild',
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::UIElement *'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'addChild',
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::UIElement *'}, {link: '', type: 'const int &'}],
...
return: {link: '', type: 'void'},
 ...
 signature: [{link: '', type: 'Item'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
 description: '        Creates a child element for some user-defined object by using the        item-template supplied in the layout file        '}, {name: 'onItemAdded',
 signature: [{link: '', type: 'Item'}, {link: '', type: 'Apollo::Elements::ListView::Bindings'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
 description: '        Handles items being added to the ListView from an ObservableCollection.        See ObservableCollection::add, apollo\lib\databinding.h        '}, {name: 'clearTemplateItems',
 signature: [],
return: {link: '', type: 'void'},
 description: '        Deletes all of this container\'s children.        TODO: this should probably just be clear(), and be in Container        '}, {name: 'onWindowReady',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'handleMouseScroll',
 signature: [{link: '/services/mouse/messages.h', type: 'const Mouse::Scroll &'}],
return: {link: '', type: 'void'},
 description: '        ////////////////////////////        Control interface        ////////////////////////////        '}]}, {name: 'ListViewConfiguration',
 classComment: '',
 publicMethods: []}], freeFunctions: [{name: 'parseListView',
 signature: [{link: '/saturn/parsing.h', type: 'Saturn::Parse::SExpression *'}],
return: {link: '', type: 'std::optional<ListViewConfiguration>'},
 description: '    Tries to create a ListViewConfiguration from the given s-expression,    and then a ListView can be created using that config    '}]}}]}, 
{type: 'file',
 classType: 'fileType',
 name: 'application.h',
...
return: {link: '', type: 'void'},
 ...
 signature: [{link: '', type: 'uint32_t'}, {link: '', type: 'uint32_t'}, {link: '', type: 'uint32_t'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'handleMessage',
 signature: [{link: '', type: 'int &'}],
return: {link: '', type: 'void'},
 description: '        Default handler for when derived applications just want default        behaviour for some message        '}]}], freeFunctions: [{name: 'hasUpdateFunction',
 signature: [{link: '', type: 'int'}],
return: {link: '', type: 'decltype(std::declval<T>().update() , std::true_type{})'},
 description: '    Helper functions that determine whether T has a function update    taking no parameters. Used to determine at compile time whether    to add a call to update or not.    '}, {name: 'hasUpdateFunction',
 signature: [{link: '', type: 'long'}],
return: {link: '', type: 'std::false_type'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
 name: 'databinding.h',
...
return: {link: '', type: 'void'},
 ...
 publicMethods: [{name: 'add',
 signature: [{link: '', type: 'Item'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'clear',
 signature: [],
return: {link: '', type: 'void'},
...
return: {link: '', type: 'void'},
 ...
 classComment: '',
 publicMethods: [{name: 'onItemAdded',
 signature: [{link: '', type: 'Item'}, {link: '', type: 'BindFunc'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'bindTo',
 signature: [{link: '', type: 'ObservableCollection<Item, BindFunc> &'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'clearItems',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}]}], freeFunctions: []}}, 
{type: 'file',
...
return: {link: '', type: 'std::optional<std::variant<KnownContainers, KnownElements> >'},
 description: ''}, {name: 'createElement',
 signature: [{link: '/services/apollo/lib/elements/container.h', type: 'Apollo::Elements::Container *'}, {link: '', type: 'Apollo::Elements::KnownElements'}, {link: '/saturn/parsing.h', type: 'Saturn::Parse::Constructor'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}],
return: {link: '', type: 'std::optional<UIElement *>'},
 description: ''}, {name: 'createElement',
 signature: [{link: '/services/apollo/lib/elements/container.h', type: 'Apollo::Elements::Container *'}, {link: '', type: 'Apollo::Elements::KnownElements'}, {link: '/saturn/parsing.h', type: 'Saturn::Parse::Constructor'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}, {link: '', type: 'int &'}],
return: {link: '', type: 'std::optional<UIElement *>'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
...
return: {link: '', type: 'bool'},
 ...
 signature: [],
return: {link: '', type: 'int'},
 description: ''}, {name: 'createContainer',
 signature: [{link: '/services/apollo/lib/elements/container.h', type: 'Apollo::Elements::Container *'}, {link: '', type: 'Apollo::Elements::KnownContainers'}, {link: '/saturn/parsing.h', type: 'Saturn::Parse::Constructor'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}, {link: '', type: 'std::optional<Control *> &'}],
return: {link: '', type: 'std::optional<Container *>'},
 description: ''}, {name: 'createContainerItems',
 signature: [{link: '/services/apollo/lib/elements/container.h', type: 'Apollo::Elements::Container *'}, {link: '/saturn/parsing.h', type: 'Saturn::Parse::SExpression *'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}, {link: '', type: 'std::optional<Control *> &'}],
return: {link: '', type: 'bool'},
...
return: {link: '', type: 'std::optional<Container *>'},
 ...
 signature: [{link: '/services/apollo/lib/elements/container.h', type: 'Apollo::Elements::Container *'}, {link: '', type: 'Apollo::Elements::KnownContainers'}, {link: '/saturn/parsing.h', type: 'Saturn::Parse::Constructor'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}, {link: '', type: 'std::optional<Control *> &'}],
return: {link: '', type: 'std::optional<Container *>'},
 description: ''}, {name: 'loadLayout',
 signature: [{link: '/saturn/parsing.h', type: 'Saturn::Parse::SExpression *'}, {link: '/services/apollo/lib/window.h', type: 'Apollo::Window *'}, {link: '', type: 'BindFunc'}, {link: '', type: 'CollectionBindFunc'}, {link: '', type: 'std::optional<Control *> &'}],
return: {link: '', type: 'std::optional<Container *>'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
...
return: {link: '', type: 'void'},
 ...
 signature: [{link: '/services/apollo/lib/elements/element.h', type: 'Apollo::Elements::UIElement *'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'setInitialFocus',
 signature: [{link: '', type: 'std::optional<Elements::Control *>'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'signalWindowReady',
 signature: [],
return: {link: '', type: 'void'},
 description: ''}, {name: 'handleMouseScroll',
 signature: [{link: '/services/mouse/messages.h', type: 'const Mouse::Scroll &'}],
...
return: {link: '', type: 'void'},
 description: ''}, {name: 'writeTransaction',
 signature: [{link: '', type: 'const char *'}, {link: '', type: 'Arg'}, {link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'void'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
...
return: {link: '', type: 'bool'},
 ...
 classComment: '',
 publicMethods: []}], freeFunctions: [{name: 'makeRequester',
 signature: [{link: '', type: 'Read &&'}, {link: '', type: 'Write &&'}],
return: {link: '', type: 'Requester<std::remove_reference_t<Read>, std::remove_reference_t<Write> >'},
 description: ''}, {name: 'makeTransfer',
 signature: [{link: '', type: 'Read &&'}, {link: '', type: 'Write &&'}],
return: {link: '', type: 'Transfer<std::remove_reference_t<Read>, std::remove_reference_t<Write> >'},
 description: ''}]}}, 
{type: 'file',
 classType: 'fileType',
 name: 'system.h',
...
return: {link: '', type: 'Vostok::ArgTypes'},
 description: ''}, {name: 'write',
 signature: [{link: '', type: 'T'}, {link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'writeValueWithType',
 signature: [{link: '', type: 'T'}, {link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'void'},
...
return: {link: '', type: 'T'},
 ...
 signature: [],
return: {link: '', type: 'bool'},
 description: ''}]}], freeFunctions: [{name: 'write',
 signature: [{link: '', type: 'char *'}, {link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'write',
 signature: [{link: '', type: 'const char *'}, {link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'void'},
 description: ''}, {name: 'writeValueWithType',
 signature: [{link: '', type: 'char *'}, {link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'void'},
...
return: {link: '', type: 'char *'},
 ...
 signature: [{link: '', type: 'Vostok::ArgTypes'}],
return: {link: '', type: 'const char *'},
 description: ''}, {name: 'replyWriteSucceeded',
 signature: [{link: '', type: 'uint32_t'}, {link: '', type: 'uint32_t'}, {link: '', type: 'bool'}, {link: '', type: 'bool'}],
return: {link: '', type: 'void'},
